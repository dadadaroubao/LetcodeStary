...
public class WordLadderⅡ {
	public static void main(String[] args) {
		List<String> list=new ArrayList<String>();
		String[] s={"hot","dot","dog","lot","log","hit","cog"};
		for(int i=0;i<s.length;i++) {
			list.add(s[i]);
		}
		System.out.println(list.toString());
		System.out.println(findLadders("hit","cog",list).toString());
	}
	 ...
	 public static List<List<String>> findLadders(String beginWord, String endWord, List<String> wordList) {
		...
		private static boolean doubleBfs(Set<String> begin, Set<String> end, Map<String, List<String>> neighborsMap,
		...
		// 深度优先，确定路径
		private static void dfs(Map<String, List<String>> neighborsMap, List<List<String>> result,
